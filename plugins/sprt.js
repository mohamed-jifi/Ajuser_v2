...
Asena.addCommand({pattern: 'ToxicMwon', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
        
    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "Ente Boss ne tholpikkaan ningalkavilla. Jeevitathil Enne tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Jifi says i love you 😘";
r_text[3] = "ക്രീം ബിസ്കറ്റിൽ ക്രീം ഉണ്ടെന്നു കരുതി ടൈഗർ ബിസ്‌ക്കറ്റിൽ ടൈഗർ ഉണ്ടാകണം എന്നില്ല.... പണി പാളും മോനെ...     -Toxic Mwon";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "ഞാൻ പറയുന്നതേ ചെയ്യൂ... ചെയ്യുന്നതേ പറയൂ... I can do that... do that I can....  നിന്റെ പണി പാളുമേ...!!";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per ToxicMwon,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than Jifi";
...
r_text[13] = ".song adich thangalude fav song name ToxicMwon ath download aakki theraam";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe ToxicMwon pazhaya ToxicMwon thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik ToxicMwon pinne ente bossinum 😼";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. ToxicMwon";
...
Asena.addCommand({pattern: 'ToxicMwon', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
r_text[12] = "രണ്ട് ബക്കറ്റ് നിറയെ വെള്ളമുണ്ട്. അതിൽ ഒരു ബക്കറ്റിനു ദ്വാരമുള്ളതാണ്. എന്നാൽ ദ്വാരമുള്ള ബക്കറ്റിൽ നിന്നും വെള്ളം പോകുന്നില്ല. കാരണം എന്താണ്? para ninak vivaram indo nokkatte";
r_text[13] = ".song adich thangalude fav song name ToxicMwon ath download aakki theraam";
r_text[14] = "ആകാശത്ത് പറക്കുന്ന പക്ഷിയെ ഏണി വച്ചു പിടിക്കാൻ നോക്കല്ലേ...   _പണി പാളും_ 🤨";
r_text[15] = "hi.. ningal ente fan aano..?";
r_text[16] = "ivide aaro ente per villichallo.. nee aano..?";
r_text[17] = "\n hey mishter Say your name..?";
r_text[18] = "enikk njan und Njan uyir";
